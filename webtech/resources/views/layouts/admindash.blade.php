...
<body class="fixed-left">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="{{url('admin/home')}}" class="logo"><i class="md md-terrain"></i> <span>Web TechBD</span></a>
                </div>
            </div>
                    ...
                    <div class="">
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            <li class="dropdown hidden-xs">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{ url(Auth::user()->admin_photo)}}" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{route('myprofile')}}"><i class="md md-face-unlock"></i> Profile</a></li>
                                        <li><a href="#"><i class="md md-settings"></i> Change Profile</a></li>
                ...
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            ...
                            <img src="{{ url(Auth::user('admin')->admin_photo) }}" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{route('applied.student')}}">Applied Student</a></li>
                                    <li><a href="{{route('manage.student')}}">Manage Student</a></li>
                                    <li><a href="{{route('view.courses')}}">Manage Courses</a></li>
                                    <li><a href="{{route('view.service')}}">Manage Service</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{route('add.shift')}}">Add Shift</a></li>
                                    <li><a href="{{route('add.service')}}">Add Service</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-message"></i> <span> Mail </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{route('admin.inbox')}}">Inbox</a></li>
                                    <li><a href="{{route('all.mails')}}">All Mail</a></li>
                                </ul>
                            </li>
   ...
   {{--      <script src="{{ asset('public/backend/assets/flot-chart/jquery.flot.js') }}"></script>
        ...
        <!-- CUSTOM JS -->
        <script src="{{ asset('public/backend/js/jquery.app.js') }}" type="text/javascript"></script>

        <!-- Dashboard -->
        <script src="{{ asset('public/backend/js/jquery.dashboard.js') }}" type="text/javascript"></script>
...
{{--         <script src="{{ asset('public/backend/js/jquery.chat.js') }}"></script> --}}
        ...
        <script src="{{ asset('public/backend/assets/datatables/jquery.dataTables.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('public/backend/assets/datatables/dataTables.bootstrap.js') }}" type="text/javascript"></script>
        <script src="{{asset('public/backend/js/toastr.js')}}" type="text/javascript"></script>

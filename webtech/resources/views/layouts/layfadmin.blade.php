...
<head>
    ...
    <title>Web TechBD | Student</title>
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="{{url('/home')}}" class="logo"><i class="md md-terrain"></i> <span>Web TechBD</span></a>
                </div>
            </div>
                    ...
                    <div class="">
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            <li class="dropdown hidden-xs">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{ Auth::user()->student_photo }}" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{route('myprofile')}}"><i class="md md-face-unlock"></i> Profile</a></li>
                                        <li><a href="{{route('change.profile')}}"><i class="md md-settings"></i> Change Profile</a></li>
                                        <li><a href="{{route('change.password')}}"><i class="md md-lock"></i> Change Password</a></li>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src="{{ Auth::user()->student_photo }}" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">{{Auth::user()->name}} <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="{{route('myprofile')}}"><i class="md md-face-unlock"></i> Profile<div class="ripple-wrapper"></div></a></li>

...
<header class="opt5 landing"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container"> <a class="navbar-brand" href="{{URL::to('/')}}"><img src="{{url('public/frontend/images/logo.png')}}" class="img-fluid logo1" alt=""><img src="{{url('public/frontend/images/landing-logo.png')}}" class="img-fluid logo2" alt=""></a>
    ...
    <div class="container">
        <div class="contents row">
            <div class="col-md-6">
                <h1>Introducing<br>
                Web TechBD</h1>
                <p>Web TechBD is a web based software development compnay. We Belive in works.</p>
                <a href="{{route('about.us')}}" class="get-started btn">More About Us</a> </div>
            </div>
        </div>
        <div class="scroll-down-mouse">
            <div class="icon"><a href="http://protechtheme.com/saas/#demo-top" class="scroll-link"><img src="{{('public/frontend/images/mouse-icon.png')}}" alt=""></a></div>
        </div>
</section>

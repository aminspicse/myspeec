...
?>
	...
	<div class="row">
		...
		<br><br>
		<form class="form-inline container-fluid" action="../five-madrasah/five_update.php" method="get" name="form1">
		...
		<form class="form-inline container-fluid" action="../four-madrasah/four_update.php" method="get" name="form2">
			<div class="row text-center container-fluid">
				<div class="form-group text-center">
		...
		<br>
		<form class="form-inline container-fluid" action="../three-madrasah/three_update.php" method="get" name="form1">
			<div class="row text-center container-fluid">
				<div class="form-group text-center">

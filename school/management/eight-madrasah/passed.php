<?php
	...
	$sql2 = "SELECT * FROM $table WHERE admin_id = '$sesid' and semester = '$semester' and status = 'Passed' and year = '$year' and classs = 'Eight' and delete_status = '0' ORDER BY gpa DESC, total_mark DESC";
	$exe2 = mysqli_query($con, $sql2);
	$result = mysqli_num_rows($exe2);
	
	//$num = ("%d",$result);
	$sql1 = "SELECT * FROM $table WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and classs = 'Eight' and delete_status = '0'";
...
?>
	...
	<div class="row">
		...
		<h5 class="text-center pra">Class Eight<small> (List of Passed)</small></h5>
	</div>
	<div class="container">

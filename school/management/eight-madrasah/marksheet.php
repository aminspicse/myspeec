<?php
  ...
  $year = $setting['year'];
	...
	$sql = "SELECT * FROM eight_madrasah WHERE admin_id = '$sesa' and semester = '$semester' and year = '$year' and delete_status = '0' ORDER BY gpa DESC, total_mark DESC";
  ...
  <tr>
    <td width="311" colspan="5"><table width="595" height="842" align="center" cellpadding="0" bordercolor="#FFFFFF" border="0">
	 ...
	 <span class="style3">Post: Sylhet-3100, Dakshin Surma, Sylhet</span><br>
      <span class="style3"><?php echo $setting['semester']." Examination - ".$setting['year']." (Class Eight)" ?></span>
      </caption>
      <tr>

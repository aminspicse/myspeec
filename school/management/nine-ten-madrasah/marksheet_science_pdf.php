<?php
	...
	$pdf->Cell(10,12,$result['quran_hadith_gread'],1,0,'C');
	$pdf->Cell(12,12,$result['quran_hadith_gpa'],1,0,'C');
	$pdf->Cell(0,6,'',0,1,'C');
	...
	$pdf->Cell(60,6,'Physics',1,0,'L');
	$pdf->Cell(10,6,$result['ph_mcq'],1,0,'C');
	$pdf->Cell(10,6,$result['ph_wr'],1,0,'C');
	$pdf->Cell(10,6,$result['ph_pt'],1,0,'C');
	$pdf->Cell(13,6,$result['ph_mcq'] + $result['ph_wr'] + $result['ph_pt'],1,0,'C');
	$pdf->Cell(15,6,$result['ph_parcent'],1,0,'C');
	$pdf->Cell(10,6,$result['ph_incourse'],1,0,'C');
	$pdf->Cell(15,6,$result['ph_total'],1,0,'C');
	$pdf->Cell(10,6,$result['ph_gread'],1,0,'C');
	$pdf->Cell(12,6,$result['ph_gpa'],1,1,'C');
	
	$pdf->Cell(8,6,'12',1,0,'C');
	$pdf->Cell(60,6,'Chemistry',1,0,'L');
	$pdf->Cell(10,6,$result['ch_mcq'],1,0,'C');
	$pdf->Cell(10,6,$result['ch_wr'],1,0,'C');
	$pdf->Cell(10,6,$result['ch_pt'],1,0,'C');
	$pdf->Cell(13,6,$result['ch_mcq'] + $result['ch_pt'] + $result['ch_wr'],1,0,'C');
	$pdf->Cell(15,6,$result['ch_parcent'],1,0,'C');
	$pdf->Cell(10,6,$result['ch_incourse'],1,0,'C');
	$pdf->Cell(15,6,$result['ch_total'],1,0,'C');
	$pdf->Cell(10,6,$result['ch_gread'],1,0,'C');
	$pdf->Cell(12,6,$result['ch_gpa'],1,1,'C');
	
	$pdf->Cell(8,6,'13',1,0,'C');
	$pdf->Cell(60,6,'Biology',1,0,'L');
	$pdf->Cell(10,6,$result['bio_mcq'],1,0,'C');
	$pdf->Cell(10,6,$result['bio_wr'],1,0,'C');
	$pdf->Cell(10,6,$result['bio_pt'],1,0,'C');
	$pdf->Cell(13,6,$result['bio_mcq'] + $result['bio_pt'] + $result['bio_wr'],1,0,'C');
	$pdf->Cell(15,6,$result['bio_parcent'],1,0,'C');
	$pdf->Cell(10,6,$result['bio_incourse'],1,0,'C');
	$pdf->Cell(15,6,$result['bio_total'],1,0,'C');
	$pdf->Cell(10,6,$result['bio_gread'],1,0,'C');
	$pdf->Cell(12,6,$result['bio_gpa'],1,1,'C');

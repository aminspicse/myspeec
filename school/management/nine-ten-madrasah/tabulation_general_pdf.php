<?php
	...
	$this->Cell(24,4,'I.H',1,0,'C');
	$this->Cell(16,4,'I.C.T',1,0,'C');
	$this->Cell(24,4,'Agriculture',1,0,'C');
	$this->Cell(16,4,'Phy/Art',1,0,'C');
	$this->Cell(10,4,'Career',1,0,'C');
	...
	$pdf->SetTitle('Tabulation Sheet General Class: '.$class);
	//$pdf->Image($school_name,30,5,25,20);
	
	//$pdf->Cell(25,8,$school_name,0,1);
	...
	$pdf->Cell(16,4,'Hadith',1,0,'C');
	$pdf->Cell(10,4,'Q.H',1,0,'C');
	$pdf->Cell(16,4,'Arabic I',1,0,'C');
	$pdf->Cell(16,4,'Arabic II',1,0,'C');
	$pdf->Cell(10,4,'Arabic',1,0,'C');
	$pdf->Cell(16,4,'fiqh',1,0,'C');
	$pdf->Cell(24,4,'Bangla I',1,0,'C');
	$pdf->Cell(24,4,'Bangla II',1,0,'C');
	$pdf->Cell(10,4,'Bang.',1,0,'C');
	$pdf->Cell(16,4,'English I',1,0,'C');
	$pdf->Cell(16,4,'English II',1,0,'C');
	$pdf->Cell(10,4,'Eng.',1,0,'C');
	$pdf->Cell(24,4,'Mathmatic',1,0,'C');
	$pdf->Cell(24,4,'ih',1,0,'C');
	$pdf->Cell(16,4,'I.C.T',1,0,'C');
	$pdf->Cell(24,4,'Agriculture',1,0,'C');
	$pdf->Cell(16,4,'Phy/Art',1,0,'C');
	$pdf->Cell(10,4,'Career',1,0,'C');
	...
	*/
	...
	while($sl <= $total){while($row = $exe->fetch_assoc()){
		...
		$pdf->Cell(8,5,$row['math_wr'] + $row['math_mcq'],1,0,'C');
			//ih
		$pdf->Cell(8,5,$row['ih_mcq'],1,0,'C');
		$pdf->Cell(8,5,$row['ih_wr'],1,0,'C');
		$pdf->Cell(8,5,$row['ih_wr'] + $row['ih_mcq'],1,0,'C');
			//ICT
		...
		$pdf->Cell(8,5,$row['agri_wr'] + $row['agri_mcq'],1,0,'C');
			//Phy/Art
		$pdf->Cell(8,5,$row['physical'],1,0,'C');
		$pdf->Cell(8,5,$row['physical_parcent'],1,0,'C');
			//Career 
		$pdf->Cell(10,5,$row['carrer_total'],1,0,'C');
		...
		$pdf->Cell(8,5,$row['math_total'],1,0,'C');
			//ih
		$pdf->Cell(8,5,$row['ih_parcent'],1,0,'C');
		$pdf->Cell(8,5,$row['ih_incourse'],1,0,'C');
		$pdf->Cell(8,5,$row['ih_total'],1,0,'C');
			//ICT
		...
		$pdf->Cell(8,5,$row['agri_pt'],1,0,'C');
			//Phy/Art
		$pdf->Cell(8,5,$row['physical_incourse'],1,0,'C');
		$pdf->Cell(8,5,$row['physical_total'],1,0,'C');
			//Career 
		$pdf->Cell(10,5,$row['carrer_gpa'],1,0,'C');
		...
		$pdf->Cell(8,5,$row['math_gread'],1,0,'C');
			//ih
		$pdf->Cell(16,5,$row['ih_gpa'],1,0,'C');
		$pdf->Cell(8,5,$row['ih_gread'],1,0,'C');
			//ICT
		...
		$pdf->Cell(8,5,$row['agri_gread'],1,0,'C');
			//Phy/Art
		$pdf->Cell(8,5,$row['physical_gpa'],1,0,'C');
		$pdf->Cell(8,5,$row['physical_gread'],1,0,'C');
			//Career 
		$pdf->Cell(10,5,$row['carrer_gread'],1,0,'C');

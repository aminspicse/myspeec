<?php
	...
	$sqlr = "SELECT * FROM nine_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and status = 'Reffard' and delete_status = '0' ORDER BY roll ASC";
	$exer = mysqli_query($con, $sqlr);
	$resultr = mysqli_num_rows($exer);//End Query Reffard

	//Start Query for All student
	$sqla = "SELECT * FROM nine_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and delete_status = '0'";

<?php
	...
	if($department == 'All'){
		$sql = "SELECT * FROM $table WHERE admin_id = '$admin_id' and classs = '$class' and semester = '$semester' and year = '$year' and delete_status = '0' ORDER BY gpa DESC, total_fail ASC, total_mark DESC";
		$exe = $conn->query($sql);
	}else{

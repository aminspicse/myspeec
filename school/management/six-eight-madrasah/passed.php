...
/*
	...
	*/
	...
	//echo $sesid;
	$sql = "SELECT * FROM class_nine WHERE user_id = '$sesid' and semester = '$semester' and status = 'Passed' and year = '$year' ORDER BY gpa DESC";
	$exe = mysqli_query($con, $sql);
	$result = mysqli_num_rows($exe);
	//$num = ("%d",$result);
	$sql1 = "SELECT * FROM class_nine WHERE user_id = '$sesid' and semester = '$semester' and year = '$year'";
...
?>
	...
	<div class="row">
		<h3 class="text-center"><?php echo $ses['school_name']?></h3>
	</div>
	<div class="row">
		<h4 class="text-center"><?php echo $setting['semester']." Examination ".$setting['year'] ?></h4>
		<h5 class="text-center">Class Nine<small> (List of Passed)</small></h5>
	</div>
	<div class="container">

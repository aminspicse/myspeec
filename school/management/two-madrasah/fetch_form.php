<?php 
	...
	if(isset($_POST['roll'])){
		...
		$sql = "SELECT * FROM two_madrasah WHERE classs='$class' and semester='$semester' and year='$year' and roll='$roll' and admin_id = '$admin_id' and delete_status = '0'";
		$exe = $conn->query($sql);
			...
			$output = '
				...
				<form id="update_form">
					...
					<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
						...
						<input style="display:none;" type="text" name="class" value="Two" />

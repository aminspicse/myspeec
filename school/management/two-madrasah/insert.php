						...
						if($bangla <= 100 and $bangla_incourse <= 20){
							if($english <= 100 and $english_incourse <= 20){
								if($gkam <= 100 and $gkam_incourse <= 20){
									...
									if($result == true){
										echo $msg['success'] = 'Successfully Submit Result. <b>GPA : '.$gpa.', Grade : '.$gread.'and Status : '.$status.'</b>';
									}else{
										echo $msg['error'] = 'Subjects Mark Accept Just Integer Number. Space, Semicolon and other Character is Not Accept. Please Check Again';
									}
								}else{

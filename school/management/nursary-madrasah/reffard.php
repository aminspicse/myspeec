<?php
	...
	$year = $setting['year'];
	$table = 'nursary_madrasah';
	$class = 'Nursary';
	
	$sql = "SELECT * FROM $table WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and classs = '$class' and status = 'Reffard' and delete_status = 0 ORDER BY roll ASC";
...
?>
	...
	<div class="row">
		...
		<h5 class="text-center pra" >Class Nursary <small> (List of Reffard)</small></h5>
	</div>
	<div class="container">

		...
		<div class="col-md-10 col-sm-10 col-lg-10 col-xs-12 ">
			...
			<div class="row form-group bg-difault sub-margin">
			 ...
			 <div class="row form-group sub-margin">
    			<div class="col-md-4 col-sm-4 col-lg-4"><h4>5. <select name="ms_is" id=""><option value="Masnunnah">Masnunnah</option><option value="Islamic Study">Islamic Study</option></select> </div>
				<div class="col-md-2 col-xs-4 col-sm-2 col-lg-1"><input type="text" name="ms_is_mark" placeholder="Mark" class="" maxlength="3"></div>
				<div class="col-md-2 col-xs-4 col-sm-2 col-lg-1"><input type="text" name="ms_is_incourse" placeholder="Incourse" class=""></div>
                <div class="col-md-2 col-xs-4 col-sm-2 col-lg-1"><input type="text" name="ms_is_total" placeholder="Total" disabled class=""></div>
				<div class="col-md-1 hidden-sm hidden-xs col-lg-1 hide"><input type="text" name="ms_is_gpa" placeholder="GPA" disabled class="form-control"></div>
				<div class="col-md-1 hidden-sm hidden-xs col-lg-1 hide"><input type="text" name="ms_is_status" placeholder="Status" disabled class="form-control"></div>
			</div>
			<div class="row form-group bg-difault sub-margin">
				<div class="col-md-4 col-sm-4 col-lg-4"><h4>6. Arts :</h4> </div>

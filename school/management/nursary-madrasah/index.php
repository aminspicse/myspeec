<?php 
 ...
 ?>	
	 <div class="col-md-2 col-sm-2 col-xs-2 col-lg-2 tumbnail" style="height:768px; background:#5ae6f5">
		...
		<h3 id="button7">Delete</h3><hr>
	 </div>
	<div class="col-md-10" id="nursary" style="display:">
		<div class="row">
			<div class="col-md-10">

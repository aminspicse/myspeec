			...
			if($arabic <= 100 and $arabic_incourse <= 20){
				if($math <= 100 and $math_incourse <= 20){
					if($ms_is_mark <= 50 and $ms_is_incourse <= 10){
						...
						$msg['error'] = $ms_is." Your Current Input Mark = (".$ms_is_mark.") and Incourse = (".$ms_is_incourse.") You Must Entered Mark <= 50 and Incourse <= 20";
					}
				}else{

<?php
	...
	while($result = $exe->fetch_assoc()){
		...
		*/
		...
		$pdf->Cell(70,7,$result['ms_is'],1,0,'L');
		$pdf->Cell(15,7,$result['ms_is_mark'],1,0,'C');
		$pdf->Cell(15,7,$result['ms_is_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['ms_is_incourse'],1,0,'C');
		$pdf->Cell(15,7,$result['ms_is_total'],1,0,'C');
		$pdf->Cell(15,7,$result['ms_is_gread'],1,0,'C');
		$pdf->Cell(13,7,$result['ms_is_gpa'],1,1,'C');	
		
		$pdf->Cell(5,7,'',0,0);
		$pdf->SetFont('arial','b', 12);
		$pdf->Cell(10,7,'06',1,0,'C');
		$pdf->Cell(70,7,'Arts and Craft',1,0,'L');
		$pdf->Cell(15,7,$result['arts'],1,0,'C');
		$pdf->Cell(15,7,$result['arts_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['arts_incourse'],1,0,'C');
		$pdf->Cell(15,7,$result['arts_total'],1,0,'C');
		$pdf->Cell(15,7,$result['arts_gread'],1,0,'C');
		$pdf->Cell(13,7,$result['arts_gpa'],1,1,'C');	
		...
		//$pdf->Cell(50,7,$result['arabic_total'] + $result['bangla_total'] + $result['english_total'] + $result['math_total'] + $result['ms_is_total'] + $result['arts_total'],1,0,'L');

<?php 
	...
	if(isset($_POST['roll'])){
		...
		$sql = "SELECT * FROM nursary_madrasah WHERE classs='$class' and semester='$semester' and year='$year' and roll='$roll' and admin_id = '$admin_id' and delete_status = '0'";
		$exe = $conn->query($sql);
			...
			$output = '
				...
				<form id="update_form">
					...
					<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
						...
						<div class="row form-group">
							<div class="col-md-4 col-sm-3 col-lg-4 txt-margin"><h4>5.'.$rows['ms_is'].':</h4> </div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1 txt-margin"><input type="text" id="ms_is" name="ms_is_mark" value="'.$rows['ms_is_mark'].'" placeholder="Mark " class="" maxlength="3"></div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1 txt-margin"><input type="text" id="ms_is_incourse" name="ms_is_incourse" value="'.$rows['ms_is_incourse'].'"  placeholder="Incourse" class=""></div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1 txt-margin"><input type="text" id="ms_is_total" name="ms_is_gpa" value="'.$rows['ms_is_total'].'"  placeholder="Total" disabled class=""></div>
							<div class="col-md-1 hidden-sm hidden-xs col-lg-1 txt-margin"><input type="text" id="ms_is_gpa" name="ms_is_gread" value="'.$rows['ms_is_gpa'].'"  placeholder="GPA" disabled class=""></div>
							<div class="col-md-1 hidden-sm hidden-xs col-lg-1 txt-margin"><input type="text" id="ms_is_gread" name="ms_is_status" value="'.$rows['ms_is_status'].'"  placeholder="Status" disabled class=""></div>
						</div>
						<div class="row form-group">
						...
						<input style="display:none;" type="text" name="class" value="Nursary" />

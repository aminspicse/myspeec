...
//$table = "eight_madrasah";
	...
	if(isset($_GET['searchbtn'])){
		...
		$query = "SELECT * FROM five_madrasah WHERE admin_id = '$admin_id' and classs = '$class' and semester = '$semester' and year = '$year' and roll = '$roll'";
...
?>
		...
		<form class="form-inline container-fluid" name="" action="" method="post">
			...
			<?php include 'subject_update.php'; ?>

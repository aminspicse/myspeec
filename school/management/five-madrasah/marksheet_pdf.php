<?php
	...
	while($result = $exe->fetch_assoc()){
		...
		*/
		...
		$pdf->Cell(70,7,'Quran Mazid && Aqaid',1,0,'L');
		$pdf->Cell(15,7,$result['quran_aqaid'],1,0,'C');
		$pdf->Cell(15,7,$result['quran_aqaid_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['quran_aqaid_incourse'],1,0,'C');
		$pdf->Cell(15,7,$result['quran_aqaid_total'],1,0,'C');
		$pdf->Cell(15,7,$result['quran_aqaid_gread'],1,0,'C');
		$pdf->Cell(13,7,$result['quran_aqaid_gpa'],1,1,'C');
		...
		$pdf->Cell(13,7,$result['arabic_gpa'],1,0,'C');
		$pdf->Cell(1,7,'',0,1);
/* 
		$pdf->Cell(5,7,'',0,0);
		$pdf->Cell(10,7,'03',1,0,'C');
		$pdf->Cell(70,7,'Arabic II',1,0,'L');
		$pdf->Cell(15,7,$result['arabic2nd'],1,0,'C');
		$pdf->Cell(15,7,$result['arabic2nd_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['arabic2nd_incourse'],1,1,'C');
		
		$pdf->Cell(5,7,'',0,0);
		$pdf->Cell(10,7,'04',1,0,'C');
		$pdf->Cell(70,7,'Aqaid and Fiqh',1,0,'L');
		...
		$pdf->Cell(70,7,'Science & B.G.S',1,0,'L');
		$pdf->Cell(15,7,$result['science_bgs'],1,0,'C');
		$pdf->Cell(15,7,$result['science_bgs_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['science_bgs_incourse'],1,0,'C');
		$pdf->Cell(15,7,$result['science_bgs_total'],1,0,'C');
		$pdf->Cell(15,7,$result['science_bgs_gread'],1,0,'C');
		$pdf->Cell(13,7,$result['science_bgs_gpa'],1,1,'C');
		/* 
		$pdf->Cell(5,7,'',0,0);
		$pdf->SetFont('arial','', 12);
		$pdf->Cell(10,7,'09',1,0,'C');
		$pdf->Cell(70,7,'Bangladesh & Global Studies',1,0,'L');
		$pdf->Cell(15,7,$result['bgs'],1,0,'C');
		$pdf->Cell(15,7,$result['bgs_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['bgs_incourse'],1,0,'C');
		$pdf->Cell(15,7,$result['bgs_total'],1,0,'C');
		$pdf->Cell(15,7,$result['bgs_gread'],1,0,'C');
		$pdf->Cell(13,7,$result['bgs_gpa'],1,1,'C');	
		 */
		$pdf->Cell(170,4,'',0,1);
		...
		//$pdf->Cell(50,7,$result['quran_aqaid_total'] + $result['arabic_total'] + $result['english_total'] + $result['bangla_total'] + $result['math_total'] + $result['science_bgs_total'],1,0,'L');

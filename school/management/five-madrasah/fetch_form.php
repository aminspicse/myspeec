<?php 
	...
	if(isset($_POST['roll'])){
		...
		$sql = "SELECT * FROM five_madrasah WHERE classs='$class' and semester='$semester' and year='$year' and roll='$roll' and admin_id = '$admin_id' and delete_status = '0'";
		$exe = $conn->query($sql);
				...
				<form id="update_form">
					...
					<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12 col-md-offset-2">
						<div class="row form-group">
							<div class="col-md-4 col-sm-3 col-lg-4"><h4>1. Quran && Aqaid:</h4> </div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1"><input type="text" name="quran_aqaid" value="'.$rows['quran_aqaid'].'" placeholder="Q A" class="" maxlength="3"></div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1"><input type="text" name="quran_aqaid_incourse" value="'.$rows['quran_aqaid_incourse'].'"  placeholder="Incourse" class=""></div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1"><input type="text" name="quran_aqaid_gpa" value="'.$rows['quran_aqaid_total'].'"  placeholder="Total" disabled class=""></div>
							<div class="col-md-1 hidden-sm hidden-xs col-lg-1"><input type="text" name="quran_aqaid_gread" value="'.$rows['quran_aqaid_gpa'].'"  placeholder="GPA" disabled class=""></div>
							<div class="col-md-1 hidden-sm hidden-xs col-lg-1"><input type="text" name="quran_aqaid_status" value="'.$rows['quran_aqaid_status'].'"  placeholder="Status" disabled class=""></div>
						</div>
						<div class="row form-group">
						...
						<div class="row form-group">
							<div class="col-md-4 col-sm-3 col-lg-4 txt-margin"><h4>3. Bangla:</h4> </div>
						...
						<div class="row form-group">
							<div class="col-md-4 col-sm-3 col-lg-4 txt-margin"><h4>4. English:</h4> </div>
						...
						<div class="row form-group">
							<div class="col-md-4 col-sm-3 col-lg-4 txt-margin"><h4>5. Mathmatic: </h4> </div>
						...
						<div class="row form-group">
							<div class="col-md-4 col-sm-3 col-lg-4 txt-margin"><h4>6. Science && BGS: </h4> </div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1 txt-margin"><input type="text" id="science_bgs" name="science_bgs" value="'.$rows['science_bgs'].'" placeholder="S BGS" class="" maxlength="3"></div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1 txt-margin"><input type="text" id="science_bgs_incourse" name="science_bgs_incourse" value="'.$rows['science_bgs_incourse'].'"  placeholder="Incourse" class=""></div>
							<div class="col-md-1 col-xs-4 col-sm-2 col-lg-1 txt-margin"><input type="text" id="science_bgs_total" name="science_bgs_gpa" value="'.$rows['science_bgs_total'].'"  placeholder="Total" disabled class=""></div>
							<div class="col-md-1 hidden-sm hidden-xs col-lg-1 txt-margin"><input type="text" id="science_bgs_gpa" name="science_bgs_gread" value="'.$rows['science_bgs_gpa'].'"  placeholder="GPA" disabled class=""></div>
							<div class="col-md-1 hidden-sm hidden-xs col-lg-1 txt-margin"><input type="text" id="science_bgs_gread" name="science_bgs_status" value="'.$rows['science_bgs_status'].'"  placeholder="Status" disabled class=""></div>
						</div>

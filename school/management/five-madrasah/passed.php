<?php
	...
	//echo $sesid;
	$sql2 = "SELECT * FROM five_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and status = 'Passed' and year = '$year' and classs = 'Five' and delete_status = '0' ORDER BY gpa DESC, total_mark DESC";
...
?>
	...
	<div class="row">
		...
		<h5 class="text-center pra">Class Five<small> (List of Passed)</small></h5>
	</div>
	<div class="container">

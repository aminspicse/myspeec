						...
						if($english <= 100 and $english_incourse <= 20){
							if($science_bgs <= 100 and $science_bgs_incourse <= 20){
								if($math <= 100 and $math_incourse <= 20){
									...
									$status = status($gpa);	
									$sql = "INSERT INTO five_madrasah(admin_id, name, roll, student_id, classs, semester, year, department, quran_aqaid, quran_aqaid_parcent, quran_aqaid_incourse, quran_aqaid_total, quran_aqaid_gpa, quran_aqaid_gread, quran_aqaid_status, arabic, arabic_parcent, arabic_incourse, arabic_total, arabic_gpa, arabic_gread, arabic_status, bangla, bangla_parcent, bangla_incourse, bangla_total, bangla_gpa, bangla_gread, bangla_status, english, english_parcent, english_incourse, english_total, english_gpa, english_gread, english_status, math, math_parcent, math_incourse, math_total, math_gpa, math_gread, math_status, science_bgs, science_bgs_parcent, science_bgs_incourse, science_bgs_total, science_bgs_gpa, science_bgs_gread, science_bgs_status, total_mark, gpa, gread, status, total_fail, insert_time) VALUES('$admin_id', '$name', '$roll', '$student_id', '$classs', '$semester', '$year', '$department', '$quran_aqaid', '$quran_aqaid_parcent', '$quran_aqaid_incourse', '$quran_aqaid_total', '$quran_aqaid_gpa', '$quran_aqaid_gread', '$quran_aqaid_status', '$arabic', '$arabic_parcent', '$arabic_incourse', '$arabic_total', '$arabic_gpa', '$arabic_gread', '$arabic_status', '$bangla', '$bangla_parcent', '$bangla_incourse', '$bangla_total', '$bangla_gpa', '$bangla_gread', '$bangla_status', '$english', '$english_parcent', '$english_incourse', '$english_total', '$english_gpa', '$english_gread', '$english_status', '$math', '$math_parcent', '$math_incourse', '$math_total', '$math_gpa', '$math_gread', '$math_status', '$science_bgs', '$science_bgs_parcent', '$science_bgs_incourse', '$science_bgs_total', '$science_bgs_gpa', '$science_bgs_gread', '$science_bgs_status', '$total_mark', '$gpa', '$gread', '$status', '$total_fail', '$insert_time')";

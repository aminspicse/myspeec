<?php
	...
	while($result = $exe->fetch_assoc()){
		...
		*/
		...
		$pdf->Cell(5,7,'',0,0);
		$pdf->SetFont('arial','', 12);
		$pdf->Cell(10,7,'08',1,0,'C');
		$pdf->Cell(70,7,'General Science',1,0,'L');
		$pdf->Cell(15,7,$result['science'],1,0,'C');
		$pdf->Cell(15,7,$result['science_parcent'],1,0,'C');
		$pdf->Cell(12,7,$result['science_incourse'],1,0,'C');
		$pdf->Cell(15,7,$result['science_total'],1,0,'C');
		$pdf->Cell(15,7,$result['science_gread'],1,0,'C');
		$pdf->Cell(13,7,$result['science_gpa'],1,1,'C');
		
		
		$pdf->Cell(5,7,'',0,0);
		$pdf->SetFont('arial','', 12);
		$pdf->Cell(10,7,'09',1,0,'C');
		$pdf->Cell(70,7,'General knowledge Arts & Masnuna',1,0,'L');
		...
		//$pdf->Cell(50,7,$result['quran_total'] + $result['arabic_total'] + $result['aqaid_total'] + $result['english_total'] + $result['bangla_total'] + $result['math_total'] + $result['science_total'] + $result['bgs_total'] + $result['gkam_total'],1,0,'L');

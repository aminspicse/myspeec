<?php 
	...
	if(isset($_GET['searchbtn'])){
		...
		$query = "SELECT * FROM six_madrasah WHERE admin_id = '$admin_id' and classs = '$class' and semester = '$semester' and year = '$year' and roll = '$roll' and delete_status = '0'";
...
?>
	...
	<div class="row">
			...
			?>
			<div class="col-md-11 col-md-offset-1">
				<p class="text-center pra" style="font-size:2vw">Class Six <?php echo $rows['semester']." Examination - ".$rows['year']; ?></p>
			</div>
		</div>
		...
		<form class="form-inline container-fluid" name="" action="" method="post">
			...
			<input style="display:none;" type="text" name="class" value="Six" />
		</form>
	</body>
</html>
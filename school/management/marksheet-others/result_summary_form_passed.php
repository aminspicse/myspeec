...
<?php if($action == true){?>
<form <?php  ?> action="../six-eight-madrasah/summary_passed.php" method="get" class="" style="">
...
<!--	<div class="row col-md-offset-1">
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-8">
			<button class="btn btn-lg btn-success" name="summary">Generate Result Summary Passed</button>
		</div>
	</div>

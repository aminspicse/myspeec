<?php 
	...
	if(isset($_GET['searchbtn'])){
		...
		$query = "SELECT * FROM ten_madrasah WHERE admin_id = '$admin_id' and classs = '$class' and department = 'General' and semester = '$semester' and year = '$year' and roll = '$roll' and delete_status = '0'";

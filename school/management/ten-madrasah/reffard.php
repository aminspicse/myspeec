<?php
	...
	$sql = "SELECT * FROM ten_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and status = 'Reffard' and delete_status = '0' ORDER BY roll ASC";
	$exe = mysqli_query($con, $sql);
	$result = mysqli_num_rows($exe);
	//printf("%d", $result);
	$sql1 = "SELECT * FROM ten_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and delete_status = '0'";
...
?>
	...
	<div class="row">
		...
		<h5 class="text-center pra">Class <b>Ten</b> <small> (List of Reffard)</small></h5>
	</div>
	<div class="container">

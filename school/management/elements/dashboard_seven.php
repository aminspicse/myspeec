				...
				<div class="row container-fluid">
					<div class="col-md-12">
						<div class="main-header">
							<em class="responsive-dash">The dashboard of class Seven</em>
					...
					<div class="thumbnail tumb-set" style="background:#f3e7d9">
						...
						<div class="row padding-top col-md-offset-1" style="margin-top:-10px">
							<div class="col-md-2 col-sm-3 col-lg-3">
								...
								<ul class="dropdown-menu">
									<li><a href="../seven-madrasah/seven.php" target="_new" class="">Mark Entry</a></li>
									<li><a href="../six-eight-madrasah/search_update.php" target="_new" class="">Mark Update</a></li>
									<li><a href="../seven-madrasah/search_delete.php" target="_new" class="">Delete</a></li>
								</ul>
							</div>
							<div class="col-md-2 col-sm-3 ">
								...
								<ul class="dropdown-menu">
									<li><a href="../seven-madrasah/passed.php" target="_new">Passed</a></li>
									<li><a href="../seven-madrasah/reffard.php" target="_new">Reffard</a></li>
									<li><a href="../seven-madrasah/all_result.php" target="_new">All Status</a></li>
									<li Class="divider"></li>
							...
							<div class="col-md-2 col-sm-3">
								...
								<ul class="dropdown-menu">
									<li><a href="../seven-madrasah/marksheet.php" target="_new">Marksheet</a></li>

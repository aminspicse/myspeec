<!-- Start Class Five Dashboard -->
		<div class="" id="nursary" style="display:none">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-4">
						<ul class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="#">Nursary</a></li>
							<li class="active">Nursary Home Page</li>
						</ul>
					</div>
					<div class="col-md-8">
						...
						<div class="row container-fluid">
							<div class="col-md-12">
								<div class="main-header">
									<em class="responsive-dash">Dashboard of class Nursary</em>
							...
							<div class="thumbnail tumb-set" style="background:#f3e7d9">
								...
								<div class="row padding-top col-md-offset-1" style="margin-top:-10px">
									<div class="col-md-2 col-sm-3 col-lg-3">
										...
										<ul class="dropdown-menu">
											<li><a href="../nursary-madrasah/" target="_new" class="">Mark Entry</a></li>
											<li><a href="../nursary-madrasah/search.php" target="_new" class="">Mark Update</a></li>
									...
									<div class="col-md-2 col-sm-3 ">
										...
										<ul class="dropdown-menu">
											<li><a href="../nursary-madrasah/passed.php" target="_new">Passed</a></li>
											<li><a href="../nursary-madrasah/reffard.php" target="_new">Reffard</a></li>
											<li><a href="../nursary-madrasah/all_result.php" target="_new">All Status</a></li>
											<li></li>
										</ul>
									</div>    
									<div class="col-md-2 col-sm-3">

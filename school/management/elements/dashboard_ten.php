			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
						<ul class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="#">Ten</a></li>
				...
				<div class="row container-fluid">
					<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
						<div class="main-header">
							<em class="responsive-dash">The board of class Ten</em>
                ...
                <form action="" method="post">
	                <div class="row container-fluid thumbnail">
	                	<div class="">
		                	...
		                	<div class="col-md-3 col-sm-3 col-lg-3 col-xs-5">
						...
						<div class="row padding-top col-md-offset-1" style="margin-top:-10px">
							<div class="col-md-2 col-sm-3 col-lg-3">
								...
								<ul class="dropdown-menu">
									<li><a href="#" class="" target="_new">Mark Entry Science</a></li>
									<li><a href="#" class="" target="_new">Mark Entry General</a></li>
									<li><a href="#" class="" target="_new">Mark Entry Commarce</a></li>
					...
					<div class="thumbnail tumb-set" style="background:#f3e7d9">
						...
						<div class="row padding-top col-md-offset-1" style="margin-top:-10px">
							<div class="col-md-2 col-sm-3 col-lg-3">
								...
								<ul class="dropdown-menu">
									<li><a href="../ten-madrasah/ten_general.php" target="_new" class="">Mark Entry General</a></li>
									<li><a href="../ten-madrasah/ten_science.php" target="_new" class="">Mark Entry Science</a></li>
									<li><a href="" class="">Mark Entry Commarce</a></li>
									<li><a href="../nine-ten-madrasah/search_update.php" target="_new" class="">Mark Update</a></li>
									<li><a href="../ten-madrasah/search_delete.php" target="_new" class="">Delete</a></li>
								</ul>
							</div>
							<div class="col-md-2 col-sm-3 ">
								...
								<ul class="dropdown-menu">
									<li><a href="../ten-madrasah/passed.php" target="_new">Passed</a></li>
									<li><a href="../ten-madrasah/reffard.php" target="_new">Reffard</a></li>
									<li><a href="../ten-madrasah/all_status.php" target="_new">All Status</a></li>
									<li Class="divider"></li>
							...
							<div class="col-md-2 col-sm-3">
								...
								<ul class="dropdown-menu">
									...
									<li class="divider"></li>
									<li><a href="../six-eight-madrasah/marksheet_form.php" target="_new">Marksheet Science (pdf)</a></li>
									<li><a href="../six-eight-madrasah/marksheet_form.php" target="_new">Marksheet General (pdf)</a></li>
									<li><a href="../six-eight-madrasah/marksheet_form.php" target="_new">Marksheet Commarce (pdf)</a></li>
								</ul>
							</div>        
							<div class="col-md-2 col-sm-3">

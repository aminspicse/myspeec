		...
		<div class="right-container display-none" id="eight">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-4">
						<ul class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="#">Eight</a></li>
				...
				<div class="row container-fluid">
					<div class="col-md-12">
						<div class="main-header">
							<em class="responsive-dash">The dashboard of class Eight</em>
					...
					<div class="thumbnail tumb-set" style="background:#f3e7d9">
						...
						<div class="row padding-top col-md-offset-1" style="margin-top:-10px">
							<div class="col-md-2 col-sm-3 col-lg-3">
								...
								<ul class="dropdown-menu">
									<li><a href="../eight-madrasah/eight.php" target="_new" class="">Mark Entry</a></li>
									<li><a href="../six-eight-madrasah/search_update.php" target="_new" class="">Mark Update</a></li>
									<li><a href="../eight-madrasah/search_delete.php" target="_new" class="">Delete</a></li>
								</ul>
							</div>
							<div class="col-md-2 col-sm-3 ">
								...
								<ul class="dropdown-menu">
									<li><a href="../eight-madrasah/passed.php" target="_new">Passed</a></li>
									<li><a href="../eight-madrasah/reffard.php" target="_new">Reffard</a></li>
									<li><a href="../eight-madrasah/all_result.php" target="_new">All Status</a></li>
									<li Class="divider"></li>
							...
							<div class="col-md-2 col-sm-3">
								...
								<ul class="dropdown-menu">
									<li><a href="../eight-madrasah/marksheet.php" target="_new">Marksheet</a></li>
									<li><a href="#" target="_new">Tesimonial</a></li>
									<li><a href="#" target="_new">T.C</a></li>
									<li class="divider"></li>
									<li><a href="../six-eight-madrasah/marksheet_form.php" target="_new">Marksheet (pdf)</a></li>
								</ul>
							</div>        
							<div class="col-md-2 col-sm-3">

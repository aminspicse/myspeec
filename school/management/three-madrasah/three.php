	...
	<h2 onclick="two()">hellos</h2>
		...
		<div class="row">
			<div class="col-md-11 col-md-offset-1">
				<h2 class="text-center" style="font-size:3vw; margin:0px"><b><?php echo $ses['school_name']; ?></b></h2>
			</div>
			<div class="col-md-11 col-md-offset-1">
				<p class="text-center" style="font-size: 2vw; margin: 0px">Class <?php echo $class.' '.$setting['semester']." Examination ".$setting['year']; ?></p>
			</div>
		</div>
		<form class="form-inline container-fluid" id="submit_form">
			<div class="row container-fluid center">
			
				<?php include'../three-four-madrasah/subject.php'?>
			</div>

								...
								if($science <= 100 and $science_incourse <= 20){
									if($bgs <= 100 and $science_incourse <= 20){
										if($gkam <= 100 and $gkam_incourse <= 20){
											...
											include '../three-four-madrasah/failcount.php';

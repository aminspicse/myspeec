<?php
	...
	$sql = "SELECT * FROM three_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and classs = 'Three' and status = 'Reffard' and delete_status = 0 ORDER BY roll ASC";
...
?>
	...
	<div class="row">
		...
		<h5 class="text-center pra" >Class Three<small> (List of Reffard)</small></h5>
	</div>
	<div class="container">

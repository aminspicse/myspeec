<?php
	...
	$sql = "SELECT * FROM nine_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year' and status = 'Reffard' ORDER BY roll ASC";
	$exe = mysqli_query($con, $sql);
	$result = mysqli_num_rows($exe);
	//printf("%d", $result);
	$sql1 = "SELECT * FROM nine_madrasah WHERE admin_id = '$sesid' and semester = '$semester' and year = '$year'";
...
?>
	...
	<div class="row">
		...
		<h5 class="text-center pra">Class Nine <small> (List of Reffard)</small></h5>
	</div>
	<div class="container">

...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class CvController extends CI_Controller
    {
        ...
        public function addeducation()
        {
            ...
            else
            {
                if(isset($_POST['save']))
                {
                    ...
                    $this->Cv->save('user_education',$data);
                 }
                $this->load->view('users/header',array('keyword' => '', 'title'=>'Add Your Education', 'score' => '','others' =>''));
                $this->load->view('users/profile/profile_leftnav');
                $this->load->view('users/cv/add_education');
        ...
        {
            $query['education'] = $this->Cv->fetch_data_for_edit('user_education','education_id',$edu_id,$this->session->userdata('user_id'));
            $this->form_validation->set_rules('institute','Institute','required');
            ...
            else
            {
                if(isset($_POST['update']))
                {
                    ...
                    if($this->Cv->update_data('user_education','education_id',$edu_id, $this->session->userdata('user_id'), $data) == true)
                    {
        ...
        // delete education
         ...
         {
            if($this->Cv->delete_data('user_education', 'education_id', $edu_id, $this->session->userdata('user_id')) == true)
            {
        ...
        public function addexperience()
        {
            ...
            else
            {
                if(isset($_POST['save']))
                {
                    ...
                    $this->Cv->save('user_experience',$data);
                }
                $this->load->view('users/header',array('keyword' => '', 'title'=>'Add Experience', 'score' => '','others' =>''));
                $this->load->view('users/profile/profile_leftnav');
                $this->load->view('users/cv/add_experience');
        ...
        {
            $data['edit'] = $this->Cv->fetch_data_for_edit('user_experience','experience_id',$exp_id, $this->session->userdata('user_id'));
            $this->form_validation->set_rules('company_name','Company Name','required');
            $this->form_validation->set_rules('job_position','Job Position','required');
            if($this->form_validation->run() == FALSE)
            {
            ...
            else
            {
                if(isset($_POST['update']))
                {
                    ...
                    if($this->Cv->update_data('user_experience','experience_id',$exp_id, $this->session->userdata('user_id'), $data) == true)
                    {
        ...
        {
            if($this->Cv->delete_data('user_experience','experience_id', $exp_id, $this->session->userdata('user_id')) == true)
            {
    ...
    // Add new skill
        public function addskill()
        {
            ...
            else
            {
                if(isset($_POST['save']))
                {
                    ...
                    if($this->Cv->save('user_skill',$data) == true)
                    {
        ...
        {
            $data['skill'] = $this->Cv->fetch_data_for_edit('user_skill','skill_id',$skill_id, $this->session->userdata('user_id'));
            $this->form_validation->set_rules('skill_name','Skill Name','required');
            if($this->form_validation->run() == FALSE)
            {
            ...
            else
            {
                if(isset($_POST['update']))
                {
                    ...
                    if($this->Cv->update_data('user_skill','skill_id',$skill_id, $this->session->userdata('user_id'),$data) == true)
                    {
        ...
        {
            if($this->Cv->delete_data('user_skill','skill_id', $skill_id, $this->session->userdata('user_id')) == true)
            {
    ...
    // Add New Training
        public function addtraining()
        {
            ...
            else
            {
                if(isset($_POST['save']))
                {
                    ...
                    if($this->Cv->save('user_training',$data) == true)
                    {
        ...
        {
            $data['training'] = $this->Cv->fetch_data_for_edit('user_training','training_id',$training_id, $this->session->userdata('user_id'));
            $this->form_validation->set_rules('training_title','Training Title','required');
            if($this->form_validation->run() == FALSE)
            {
            ...
            else
            {
                if(isset($_POST['update']))
                {
                    ...
                    if($this->Cv->update_data('user_training', 'training_id', $training_id, $this->session->userdata('user_id'), $data) == true)
                    {
        ...
        {
            if($this->Cv->delete_data('user_training','training_id', $training_id, $this->session->userdata('user_id')) == true)
            {
        ...
        public function add_aboutself()
        {
            ...
            else
            {
                if(isset($_POST['submit']))
                {
                    ...
                    if($this->Cv->save('user_about',$data) == true)
                    {
        ...
        {
            $data['about'] = $this->Cv->fetch_data_for_edit('user_about','about_id',$about_id, $this->session->userdata('user_id'));
            $this->form_validation->set_rules('about_self','About Self','required');
            if($this->form_validation->run() == FALSE)
            {
            ...
            else
            {
                if(isset($_POST['update']))
                {
                    ...
                    if($this->Cv->update_data('user_about','about_id',$about_id, $this->session->userdata('user_id'),$data) == true)
                    {
        ...
        {
            if($this->Cv->delete_data('user_about','about_id', $about_id, $this->session->userdata('user_id')) == true)
            {
        ...
        {
            $data['query'] = $this->Profile->profile(); // passing personal information 
            $data['total_friend'] = $this->Profile->total_friend();//fetching total friend
            //$data['profile'] = $this->Profile->profile(); // passing personal information 
            $data['education'] = $this->Cv->fetch_data_for_view_admin('user_education','education_id',$this->session->userdata('user_id')); // fetch education
            $data['experience'] = $this->Cv->fetch_data_for_view_admin('user_experience','experience_id',$this->session->userdata('user_id'));//fetching user experience
            $data['skill'] = $this->Cv->fetch_data_for_view_admin('user_skill','skill_id',$this->session->userdata('user_id')); // fetching skill
            $data['training'] = $this->Cv->fetch_data_for_view_admin('user_training','training_id',$this->session->userdata('user_id')); // fetch user training
            $data['about_self'] = $this->Cv->fetch_data_for_view_admin('user_about','about_id', $this->session->userdata('user_id')); // fetch user about

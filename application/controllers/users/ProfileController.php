<?php 
    ...
    class ProfileController extends CI_Controller
    {
        ...
        function index()
        {
            ...
            $data['total_friend'] = $this->Profile->total_friend();
            $user_id = $this->session->userdata('user_id');
            $data['profile'] = $this->PublicProfile->Profile($user_id);
            $data['education'] = $this->Cv->fetch_data_for_view_admin('user_education','education_id',$user_id); // fetch education
            $data['training'] = $this->Cv->fetch_data_for_view_admin('user_training','training_id',$user_id);
            $data['about_self'] = $this->Cv->fetch_data_for_view_admin('user_about', 'about_id', $user_id);
        ...
        public function view_workplace(){ 
            ...
            $user_id = $this->session->userdata('user_id');
            $data['profile'] = $this->PublicProfile->Profile($user_id);
            $data['education'] = $this->Cv->fetch_data_for_view_admin('user_education', 'education_id',$user_id);
            $data['training'] = $this->Cv->fetch_data_for_view_admin('user_training', 'training_id',$user_id);
            $data['experience'] = $this->Cv->fetch_data_for_view_admin('user_experience', 'experience_id', $user_id);
            $data['skills'] = $this->Cv->fetch_data_for_view_admin('user_skill', 'skill_id', $user_id);
        ...
        public function Profilepic(){
            ...
            if(isset($_POST['submit'])){
                ...
                if($this->upload->do_upload('profileimage') == true){
                    ...
                    $this->Profile->Update_profilephoto($data);
